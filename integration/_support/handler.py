...
#     def msg2(self) -> Either[str, Msg1]:
#         return Left('nothing')

#     @trans.unit(Msg3, trans.st)
#     def unit(self) -> IdState[SpecEnv, Msg1]:
#         self.log.info('unit')
#         return IdState.set(1)

#     @trans.one(Msg4, trans.st)
#     def st(self) -> EitherState[SpecEnv, Msg1]:
#         return EitherState.pure(Msg5())

#     @trans.one(Msg5, trans.st)
#     def est_fail(self) -> EitherState[SpecEnv, Msg1]:
